...
함수는 다른 객체들과 달리 호출할 수 있는 객체(callable object)이다. 호출할 수 있는 객체는 다른 객체들과 달리 내부 메서드 `[[Call]]` 등을 가지며 고유한 프로퍼티를 가진다. 내부 메서드에 대해서는 [Property Attributes](https://github.com/leegwae/study-javascript/blob/main/Property%20Attributes.md)를 참고한다.
