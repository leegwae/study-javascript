...
ECMAScript 명세는 **프로퍼티 어트리뷰트(Property Attribute)**라는 용어를 사용하여 프로퍼티의 상태를 설명한다. 프로퍼티 어트리뷰트에 대해서는 [Property Attributes](https://github.com/leegwae/study-javascript/blob/main/Property%20Attributes.md)를 참고한다.
